...
def test_self_reflection_no_agent():
    from agent.self_reflection import ReflectionResult, SelfReflection
...
def test_self_reflection_result_summary():
    from agent.self_reflection import ReflectionIteration, ReflectionResult
...
def test_knowledge_graph_find():
    from agent.knowledge_graph import GraphNode, KnowledgeGraph
    kg = KnowledgeGraph()
...
def test_knowledge_graph_shortest_path():
    from agent.knowledge_graph import GraphEdge, GraphNode, KnowledgeGraph
    kg = KnowledgeGraph()
...
def test_docker_generate_compose(tmp_path):
    from agent.docker_orchestrator import ComposeService, generate_compose
...
def test_cloud_cost_analyse():
    from agent.cloud_cost import Resource, analyse_resources
    resources = [
...
def test_cloud_cost_dashboard():
    from agent.cloud_cost import EXAMPLE_RESOURCES, analyse_resources
